...
// "Q{}" prefix with Schematron's namespace URL
const SQ = `Q{http://purl.oclc.org/dsdl/schematron}`;
...
module.exports = (schematronDom) =>
	evaluateXPath(
		`
			...
			/*[1]/map {
				'title': @title/string(),
				'phases': array { ./sch:phase/map {
					'id': @id/string(),
					'active': array { ./sch:active/@pattern/string() }
				}},
				'patterns': array { ./sch:pattern/map {
					'name': @name/string(),
